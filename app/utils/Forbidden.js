const Forbidden = {
    ...
    forbiddenFun(content) {
        for (let i = 0; i < this.forbiddenArr.length; i++) {
            const r = new RegExp(this.forbiddenArr[i], 'ig');
    ...
    forbiddenArr : [
        ...
        'xiao77', 'xing伴侣', 'tokyohot', 'yin荡', 'jj', '日你', '日死你', '日你全家', '内部', '内部人员', '内幕', '黑幕', '机器人', '我是机器人', '测试', '测试人员', '人员']
